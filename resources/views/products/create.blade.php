                ...
                <div x-show="activeTab === 'identificacion'" x-cloak>
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="Ej: Funda de Hielo 10lb"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" placeholder="Detalles adicionales..."
                                class="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-5 py-4 text-sm font-semibold text-slate-700 focus:border-zertix-primary focus:ring-0">{{ old('description') }}</textarea>
                        </div>
