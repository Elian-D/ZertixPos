<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center">
                <a href="{{ route('sales.pos.index') }}"
                   class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-bold text-white bg-[#58c03f] hover:bg-[#4bad35] transition-colors">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sales.pos.index')" :active="request()->routeIs('sales.pos.index')">
                Ir al POS
            </x-responsive-nav-link>
        </div>
