        ...
        <tr class="hover:bg-gray-50 transition border-b border-gray-100">
            ...
            <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <button @click="$dispatch('open-modal', 'edit-tipoNegocio-{{ $item->id }}')" class="text-zertix-primary-600 hover:text-zertix-primary-900 p-1 rounded hover:bg-zertix-primary-50">
