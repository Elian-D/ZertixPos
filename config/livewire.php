...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // REQ-4.1, v1.3.0 Fase 4 — el default de Livewire ('throttle:60,1',
        // numérico) arma su clave con Auth::user()?->id, que en una ruta
        // central sin tenant activo (el Wizard, /install) dispara una query
        // a `users` contra la conexión central, donde esa tabla no existe
        // (REQ-1.7, `users` es solo por-tenant) — 500 real, reproducido
        // subiendo el logo del paso Empresa. El limiter nombrado
        // 'livewire-uploads' (AppServiceProvider::boot()) limita por IP,
        // sin tocar Auth::user() en absoluto — funciona igual en central y
        // en cualquier tenant.
        'middleware' => 'throttle:livewire-uploads',           // Example: 'throttle:5,1'            | Default: 'throttle:60,1'
